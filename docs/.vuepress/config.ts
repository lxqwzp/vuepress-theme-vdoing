...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "Pan's blog",
      description: '分享学习与总结。JavaScript,js,ES6,TypeScript,vue,React,python,css3,html5,Node,git,github等技术文章。',
    }
  },
  ...
  themeConfig: {
    ...
    repo: 'lxqwzp/vuepress-theme-vdoing', // 导航栏右侧生成Github链接
    ...
    //       title: '发邮件',
    //       link: 'mailto:2040239371@qq.com',
    //     },
    //     {
    //       iconClass: 'icon-github',
    //       title: 'GitHub',
    //       link: 'https://github.com/lxqwzp',
    //     },
    //     {
    //       iconClass: 'icon-erji',
    //       title: '听音乐',
    ...
    footer: {
      ...
      copyrightInfo:
        '学习测试 ', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
